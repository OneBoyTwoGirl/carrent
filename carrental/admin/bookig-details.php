...
<head>
	...
	<title>Car Rental Portal | Új foglalások   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Új foglalások (adatok)</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Foglalások Info</div>
...
{				?>	
	<h3 style="text-align:center; color:red">#<?php echo htmlentities($result->BookingNumber);?> Foglalás részletei</h3>

		<tr>
											<th colspan="4" style="text-align:center;color:blue">Felhasználói adatok</th>
										</tr>
										<tr>
										...
										<tr>											
											<th>E-mail azonosító</th>
											<td><?php echo htmlentities($result->EmailId);?></td>
											<th>Kapcsolatfelvételi szám</th>
